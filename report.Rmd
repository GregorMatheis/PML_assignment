...
In the context of quantified self movement many devices measure movement contently.
Devices measured belt, forearm, arm and dumbbell movement. The data are used to measure quality of barbell lifts.
...
- Excluding date and device information
...
- Within the carret package a random forest can be applied very easily

- Due to size of data set i recommend using a parallel version of random forest
...
- Model is suitable to predict classes variable